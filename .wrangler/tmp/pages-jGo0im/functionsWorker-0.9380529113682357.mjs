...
// ../.wrangler/tmp/bundle-F0376h/checked-fetch.js
...
async function onRequest4(context) {
  ...
  try {
    ...
    if (searchResult.urls && Array.isArray(searchResult.urls)) {
      ...
      urls2 = searchResult.urls.map((item) => {
      ...
      if (resultsKey && searchResult[resultsKey]) {
        urls2 = searchResult[resultsKey].map((item) => {
          if (typeof item === "string") {
            return {
              title: item,
              url: item
    ...
    console.log(`Found ${urls2.length} URLs in search results:`, urls2);
    return new Response(
      JSON.stringify({
        success: true,
        urls: urls2,
...
// ../.wrangler/tmp/pages-jGo0im/functionsRoutes-0.2772845736527274.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-F0376h/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-F0376h/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9380529113682357.mjs.map
